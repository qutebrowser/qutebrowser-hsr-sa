...
their own extensions to qutebrowser. It's also a very straightforward solution and
...
qutebrowser can expose to extensions can look. The API to get the selected text
...
Thus, the extension API will need to look like
