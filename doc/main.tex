\documentclass[a4paper,parskip=full,DIV=14,BCOR=15mm]{scrreprt}
...
\begin{table}[H]
  ...
  \begin{tabulary}{\linewidth}{rlrL}
    ...
    & cmdutils.py & 100 & \\
    & config.py & 100 & \\
    & downloads.py & 70 & \fixme{} \\
    & hook.py & 90 & \\
    & interceptor.py & 100 & \\
    & downloads.py & 100 & \strut\vspace{0.5em} \\
    components/ & \emph{Average} & 85 & \\
    & adblock.py & 93 & \\
    & caretcommands.py & 82 & \\
    & misccommands.py & 73 & \fixme{} \\
    & scrollcommands.py & 96 & \\
    & zoomcommands.py & 85 & \strut\vspace{0.5em} \\
