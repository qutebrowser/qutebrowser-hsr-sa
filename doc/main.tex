...
\begin{table}[H]
  ...
  \begin{tabulary}{\linewidth}{rlrL}
    ...
    & hook.py & 90 & \\
    & interceptor.py & 100 & \\
    & downloads.py & 100 & \strut\vspace{2.5em} \\
    components/ & \emph{Average} & 85 & \\
    & adblock.py & 93 & \\
    & caretcommands.py & 82 & \\
    & misccommands.py & 73 & Some commands (like printing) contain
                             GUI-interactions which are hard to test. \\
    & scrollcommands.py & 96 & \\
    & zoomcommands.py & 85 & \strut\vspace{2.5em} \\
    extensions/ & \emph{Average} & 89 & \\
    & interceptors.py & 94 & \\
    & loader.py & 88 & \strut\vspace{2.5em} \\
...
\begin{itemize}[parsep=5pt]
  ...
  \item Running \verb|:print| to display the print dialog and printing the
    website into a PDF file.
  \item Using the \verb|:print --pdf| file to generate a PDF file directly.
  \item Verifying that those PDF files look correct.
\end{itemize}
