...
which ultimately lead to Mozilla abandoning that approach \citep{mozilla-webext}.
...
callback which gets called with the selected text.
...
\paragraph{Other plugin APIs} There's a general consensus from browser vendors
around the Web\-Extension plugin API. Mostly compatible subsets of it are
