...
than starting a new project from scratch. By its nature, it is difficult to
...
\begin{description}
  ...
  \item[Simplicity] It should be trivial for a user to extend her qutebrowser
    ...
    requiring packaging multiple files into a custom format. Also see section
  ...
  \item[Compability] The qutebrowser project runs on a variety of different
    software versions -- various operating systems are supported (Linux, macOS, Windows,
    and more), including different Qt and Python versions. The
